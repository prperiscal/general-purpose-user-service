...
/**
 * <p>Exception to handle cases where the user object is not found or is not available for the user in the DB
 *
...
public class UserNotFoundException extends NotFoundException {
     ...
     * @since 1.0.0
     */
    public UserNotFoundException(String id, String tenant) {
     ...
     * @since 1.0.0
     */
    public UserNotFoundException(String id, String tenant, Throwable cause) {
